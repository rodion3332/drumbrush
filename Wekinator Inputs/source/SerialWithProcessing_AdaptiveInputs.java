...
public class SerialWithProcessing_AdaptiveInputs extends PApplet {
...
public void sendFeatures(String[] s) {
  ...
  public void settings() {  size(300, 250); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "SerialWithProcessing_AdaptiveInputs" };
    if (passedArgs != null) {
